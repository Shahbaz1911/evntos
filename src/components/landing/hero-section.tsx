      ...
      <div className="relative z-10 container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6 md:space-y-8 text-center md:text-left">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold font-headline leading-tight text-white md:text-primary">
            Host <span className="inline-block min-h-[1.2em] min-w-[200px] sm:min-w-[300px] md:min-w-[350px] lg:min-w-[400px] bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent md:bg-none md:text-inherit">{text}</span> Events, <span className="block">Effortlessly.</span>
          </h1>
