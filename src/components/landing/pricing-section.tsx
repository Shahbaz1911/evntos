...
export default function PricingSection() {
  ...
  return (
    <section id="pricing" className="bg-background text-foreground overflow-x-clip">
          ...
          {pricingTiers.map((tier, index) => (
            ...
            >
              <div
                ...
                style={{ transform: `scale(${1 - (pricingTiers.length - 1 - index) * 0.05})` }}
              >
                <Card className={`flex flex-col w-full ${tier.highlightClass} rounded-xl overflow-hidden min-h-[550px]`}>
